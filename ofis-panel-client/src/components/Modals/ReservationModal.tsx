...
import { TableType } from "../Cards/TableCard";
                                    ...
                                    <div className="grid grid-cols-2 gap-2 mb-4 mt-4">
                                        {
                                            times.map((time, index) => (
                                                <Button
                                                    ...
                                                    type={selectedTime.some((a:any) => a === time) ? "dashed" : table?.reservAt.some((a:any) => a === time) ? "primary" : "text"}
                                                    disabled={table?.reservAt.some((a:any) => a === time)}
                                                >
                                                    {time}
                                                </Button>
                                            ))
